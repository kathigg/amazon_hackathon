...
Visit a bill page (e.g., `/bill/hr-111-119`). The Action Card on the right should now show a **"Your Representatives in {state}"** section at the top, with photos and contact info, before you've entered any ZIP code. The CTA button text changes to "See Full Contact Info."
